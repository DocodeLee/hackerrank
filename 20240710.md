...
![image](https://github.com/DocodeLee/hackerrank/assets/167724096/ee845964-1584-4bc4-9590-99a051257c60)
### width is for the bin beause bin will have the most longest str
### use for statement and set the each line decimal, oct, hex, binary / decimal is just same with number we use
### use rjust() to print clearly
